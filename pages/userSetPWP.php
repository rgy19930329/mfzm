...
<link href="../static/css/userSetPWP.css" rel="stylesheet" type="text/css" />
...
?>
	...
	<div class="main">
		<p class="title">会员设置密保</p>
		<p>（重新设置会覆盖以前的密保）</p>
		<form action="TreatUserSetPWP.php" method="post" onsubmit="return check();">
